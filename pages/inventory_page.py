...
class InventoryPage(BasePage):
    ...
    def default_inventory_page_should_be(self):
        ...
        for index, product in enumerate(self.products):
            ...
            assert self.page.locator(self.get_element_locator_by_index(self.inventory_item_price, index)).text_content() == product['price']
            expect(self.page.locator(f'{self.inventory_item_description}[normalize-space()="{product['description']}"]')).to_be_visible()
            assert self.page.locator(self.get_element_locator_by_index(f"{self.inventory_item_button}", index)).text_content() == product['buttonAddToCartDescription']